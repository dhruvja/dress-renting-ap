...
class ShopAWidget extends StatefulWidget {
  const ShopAWidget({Key key}) : super(key: key);

  @override
  _ShopAWidgetState createState() => _ShopAWidgetState();
}

class _ShopAWidgetState extends State<ShopAWidget> {
