...
class ShopLWidget extends StatefulWidget {
  const ShopLWidget({Key key}) : super(key: key);

  @override
  _ShopLWidgetState createState() => _ShopLWidgetState();
}

class _ShopLWidgetState extends State<ShopLWidget> {
